		...
		<section id="hero" class="!pb-10">
			<row>
				<div class="col-span-full">
					...
					<p class="text-white text-center">To generate a callsheet, simply fill out the form below and click submit.<br>The form will be replaced by a list of randomly selected names.<br>As you call the names, click/tap the name to remove it from the list.</p>
				</div>
			</row>
			<row class="!py-0">
