<style>
	...
	@import url('https://fonts.googleapis.com/css2?family=La+Belle+Aurore&family=Ms+Madi&family=Parisienne&family=Seaweed+Script&display=swap');
...
<table>
	<tbody>
		...
		<tr>
			...
			<td width="50%" class="cell center sig{{ $sig }}">{{ $reg->esign }}</td>
		</tr>
		@else
		<tr>
...
<table>
	<tbody>
		...
		<tr>
			<td colspan="2" class="cell left">SIGNATURE:<br><span class="sig{{ $sig }}">{{ $reg->esign }}</span></td>
